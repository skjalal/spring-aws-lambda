# spring-aws-lambda serverless API
The spring-aws-lambda project, created with [`aws-serverless-java-container`](https://github.com/aws/serverless-java-container).
...
```bash
$ curl -s http://127.0.0.1:3000/actuator/health | python -m json.tool
...
```bash
$ curl -s https://xxxxxxx.execute-api.us-west-2.amazonaws.com/Prod/actuator/health | python -m json.tool
